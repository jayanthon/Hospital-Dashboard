...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Matrusri Hospital </a>
...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <!--<a class="list-group-item list-group-item-action" href="#list-settings" id="list-apat-list"  role="tab" data-toggle="list" aria-controls="home">Add Patient</a>
      <a class="list-group-item list-group-item-action" href="#list-settings1" id="list-dpat-list"  role="tab" data-toggle="list" aria-controls="home">Delete Patient</a>-->
