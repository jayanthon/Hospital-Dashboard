<html>
<head>
	<title>Matrusri Hospitals</title>
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp MATRUSRI HOSPITALS</h4></a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item" style="margin-right: 40px;">
            <a class="nav-link js-scroll-trigger" href="https://news.google.com/covid19/map?hl=en-IN&mid=%2Fm%2F03rk0&state=7&gl=IN&ceid=IN%3Aen" target="_blank"" style="color: white;font-family: 'IBM Plex Sans', sans-serif;"><h6>COVID19 UPDATES</h6></a>
          </li>
        </ul>
      </div>
    </div>
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="tel" minlength="10" maxlength="10" name="contact" class="form-control" placeholder="Your Phone * "  onkeydown="return alphaOnly(event);" required />
                                        </div>
                                        <div class="form-group">
